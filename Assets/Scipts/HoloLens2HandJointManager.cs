...
public class HoloLens2HandJointManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spatialCoordinateSystem = Microsoft.MixedReality.Toolkit.WindowsMixedReality.WindowsMixedRealityUtilities.SpatialCoordinateSystem;
    ...
    public void ToggleHands(){
        ...
        if (handsActive)
        {
           for (int i = 0; i < rightHandJoints.Length; i++)
            {
                rightHandJoints[i].SetActive(true);
                leftHandJoints[i].SetActive(true);
            }
        }
        else
        {
             for (int i = 0; i < rightHandJoints.Length; i++)
            {
                rightHandJoints[i].SetActive(false);
                leftHandJoints[i].SetActive(false);
            }
        }
