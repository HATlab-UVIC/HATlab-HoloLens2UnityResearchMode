...
public static class SavePLY
{
    ...
    public static void BeginPLY( bool usePropertyColor = true , bool usePropertyNormla = false){
        ...
        string filename = string.Format(@"pointCloud-{0}.ply", Time.time);
        CurrentFilePath = getPathPLY() + filename;
        writeBytesPLY();
    }
